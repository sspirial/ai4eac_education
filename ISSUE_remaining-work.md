# [Follow-up] Complete model-agnostic workflow hardening
...
- [x] Generic runner exists: `research_loop.py`
- [x] Config-driven experiments exist: `workflow.json`
- [x] Non-LLM smoke test passes in conda base (`toy_regression`)
- [x] `results.tsv` logging and keep/discard behavior are working
...
- Keep this issue open until the LLM experiment path is confirmed in base.
